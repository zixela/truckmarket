...
<div class="grid gap-4 @lg:grid-cols-3">
    <label class="block text-sm">
        ...
        <select name="load_type" class="w-full rounded-md border border-gray-300 px-3 py-2">
...
<div class="grid gap-4 @lg:grid-cols-3">
    <label class="block text-sm">
        ...
        <select name="vehicle_type" class="w-full rounded-md border border-gray-300 px-3 py-2">
            <option value="">{{ __('common.any') }}</option>
