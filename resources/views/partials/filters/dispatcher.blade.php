...
<div class="grid gap-4 @lg:grid-cols-2">
    <label class="block text-sm">
        ...
        <select name="experience" class="w-full rounded-md border border-gray-300 px-3 py-2">
    ...
    <label class="block text-sm">
        ...
        <select name="employment_type" class="w-full rounded-md border border-gray-300 px-3 py-2">
...
<div class="text-sm">
    ...
    <p class="mt-1 text-xs text-gray-500">{{ __('listings.multi_language_hint') }}</p>
</div>
