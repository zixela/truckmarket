...
<div class="grid gap-4 @lg:grid-cols-2">
    <label class="block text-sm">
        ...
        <select name="deal" class="w-full rounded-md border border-gray-300 dark:border-gray-600 px-3 py-2">
    ...
    <label class="block text-sm">
        ...
        <select name="trailer_type" class="w-full rounded-md border border-gray-300 dark:border-gray-600 px-3 py-2">
